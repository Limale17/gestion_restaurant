...
import sn.niit.restauranManagementApplication.repository.CartItemRepository;
import sn.niit.restauranManagementApplication.repository.ShoppingCartRepository;
...
public class ShoppingCartService {
	...
	public ShoppingCart addShoppingCartFirstTime(Long id, String sessionToken, int quantity) {
		...
		cartItem.setProduct(productService.getProduitById(id));
	...
	public ShoppingCart addToExistingShoppingCart(Long id, String sessionToken, int quantity) {
		...
		Produit p = productService.getProduitById(id);
